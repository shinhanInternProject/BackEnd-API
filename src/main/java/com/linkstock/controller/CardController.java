...
public class CardController {
    ...
    public ResponseEntity<?> getMonthCardHistory(@AuthenticationPrincipal PrincipalUserDetails currentUserDetails, @PathVariable Long cardSeq, @PathVariable int month) {
